...
class Plane(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, image_name, init_pos):
        ...
        self.bom_index = 0
        # 被击中时，多少次的循环 更换一张图片
        self.bom_loop_current_num = 0
        self.bom_loop_all_num = 5
    ...
    def display(self, plane_temp):
        ...
        if not self.is_hit:
            ...
            self.bom_loop_current_num += 1
            if self.bom_loop_current_num == self.bom_loop_all_num:
                self.bom_loop_current_num = 0

                self.bom_index += 1
                if self.bom_index >= len(self.bom_images):
                    self.is_hit = False
                    self.bom_loop_current_num = 0
                    self.bom_index = 0
                    self.blood -= 30
            ...
            self.screen.blit(self.bom_images[self.bom_index], self.rect)
...
class HeroPlane(Plane):
    ...
    def __init__(self, screen):
        ...
        # 飞机被击中时播放的声音
        self.bom_sound = pygame.mixer.Sound('./sound/game_over.wav')
        self.bom_sound.set_volume(0.3)
        ...
        # 被击中时，播放的动画
        self.bom_images = []
        self.bom_images.append(pygame.image.load("./feiji/hero1.png"))
        self.bom_images.append(pygame.image.load("./feiji/hero_blowup_n1.png"))
        self.bom_images.append(pygame.image.load("./feiji/hero_blowup_n2.png"))
        self.bom_images.append(pygame.image.load("./feiji/hero_blowup_n3.png"))
        self.bom_images.append(pygame.image.load("./feiji/hero_blowup_n4.png"))
    ...
    def fire(self):
        # 发射子弹
        new_bullet = Bullet(self.rect.left, self.rect.top, self.screen, "hero")
...
class EnemyPlane(Plane):
    ...
    def __init__(self, screen):
        ...
        # 这架敌机被击中时播放的声音
        self.bom_sound = pygame.mixer.Sound('./sound/enemy1_down.wav')
        self.bom_sound.set_volume(0.3)

        # 被击中时，播放的动画
        self.bom_images = []
        self.bom_images.append(pygame.image.load("./feiji/enemy0.png"))
        self.bom_images.append(pygame.image.load("./feiji/enemy0_down1.png"))
        self.bom_images.append(pygame.image.load("./feiji/enemy0_down2.png"))
        self.bom_images.append(pygame.image.load("./feiji/enemy0_down3.png"))
        self.bom_images.append(pygame.image.load("./feiji/enemy0_down4.png"))
    ...
    def fire(self):
        ...
        if num == 38:
            new_bullet = Bullet(self.rect.left, self.rect.top, self.screen, "enemy")
            self.bulletList.append(new_bullet)
...
def main():
    ...
    while True:
        ...
        hero_plane.display(enmey_plane)

        enmey_plane.move()
        enmey_plane.display(hero_plane)
        enmey_plane.fire()

        key_control(hero_plane)

        score(screen, hero_plane, enmey_plane)

        result = judge_win_or_lose(hero_plane, enmey_plane)
